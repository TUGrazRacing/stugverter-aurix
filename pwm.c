...
#define PHASE_U_DUTY            (00.0f)                                /* Initial PWM duty cycle of phase U in [%]   */
#define PHASE_V_DUTY            (00.0f)                                /* Initial PWM duty cycle of phase V in [%]   */
#define PHASE_W_DUTY            (00.0f)                                /* Initial PWM duty cycle of phase W in [%]   */
