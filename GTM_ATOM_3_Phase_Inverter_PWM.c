...
#define PHASE_DUTY_STEP         (1.0f)                                 /* PWM duty cycle step in [%]                 */

#define DEBUG_PIN                     &MODULE_P14, 5       /* PIN which will be toggled in Interrupt Service Routine (ISR) */
...
{
    IfxPort_setPinState(DEBUG_PIN, IfxPort_State_high); //used to debug time passed
    updateGtmAtom3phInvDuty();
    IfxPort_setPinState(DEBUG_PIN, IfxPort_State_low); //used to debug time passed
}
